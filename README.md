...
+ Installation of mmcv and mmseg.
  ...
  Besides, **installing `mmcv-full==1.x.x` will be better**, because some API or functions are removed in `mmcv-full==2.x.x` (you need to adjust our code for mmcv-full==2.x.x). 
