...
Our VDW dataset is quite large (2.23 million frames, over 8TB on hard drive). Heavy works are needed for open-source. Our VDW dataset can only be used for academic purposes. Once we are ready, we will release NVDS model and VDW dataset for the community. Stay tuned!
